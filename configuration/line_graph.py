...
from PyQt5.QtWidgets import QComboBox, QDialog, QApplication,QCalendarWidget,QPushButton,QVBoxLayout,QMainWindow,QWidget,QLabel,QLineEdit,QMessageBox
...
class MainWindow(QMainWindow):
    ...
    def back_window(self):
        ...
        self.close()
        self.bk_window=Form(self.ip_address,self.port,self.db_file_path)
        self.bk_window.show()
    ...
    def plot_windrose_graph(self):
        from configuration.windrose_graph import MainWindow
        self.close()
        # Open a new dialog window for the wind rose graph
        self.windrose_dialog = MainWindow(self.db_file_path,self.ip_address,self.port)
