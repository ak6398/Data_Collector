...
from PyQt5.QtWidgets import QWidget,QDialog,QMessageBox,QFileDialog, QApplication, QVBoxLayout,QLineEdit, QHBoxLayout, QPushButton, QLabel, QCalendarWidget, QMainWindow
import pandas as pd
...
class MyWidget(QMainWindow):
    """
    This class will fetch data and display widgets.
    """
    ...
    def init_ui(self):
        ...
        date_layout.addWidget(self.back_btn)
    ...
    def main_window(self):
        ...
        self.close()
        self.back_btn=Form(self.ip_address,self.port,self.db_file_path)
        self.back_btn.show()
    ...
    def export_excel(self):
        ...
        try:
            ...
            file_path,_=QFileDialog.getSaveFileName(self, "Save Excel File", file_name, "Excel Files (*.xlsx);;All Files (*)", options=options)
    ...
    def fetch_data(self, from_date, to_date):
        ...
        next_day = to_date+timedelta(days=2)
...
class PaintWidget(QWidget):
    """
    draw the rectangel green and red according the data.
    """
    ...
    def update_date(self, start_date,end_date):
        ...
        # self.hour_data = self.get_hour_data()
        self.update()
    ...
    def get_hour_data(self,date):
        try:
            ...
            cursor=conn.cursor()
            # Query total number of data points within the date range
            hour_query=""" SELECT strftime('%H', timestamp) as hour, COUNT(*) as count 
                FROM SensorData
